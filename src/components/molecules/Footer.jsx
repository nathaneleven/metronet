        ...
        <Box border="1" fontWeight="700" bgColor="#E5E5EA" color="#444444" align="center">
            <Flex p={{base:"8", xl:"50px 0"}} maxW="1272px" align="center" direction={{base: "column", md: "row"}} >
                ...
                <Flex align="center">
                    ...
                    <Button colorScheme="blue" bgColor="#7AC342" size="lg" variant="solid" borderRadius="full">Sign Up</Button>
                </Flex>
            </Flex>
            ...
            <Box p="3" bgColor="#7AC342" color="white" align="center"  >
